...
setOtpError(axiosErr.response?.data?.message || 'Gửi lại mã thất bại. Vui lòng thử lại.');
} finally {
...
className="text-brand-600 text-xs font-bold hover:text-brand-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
style={{ background: 'none', border: 'none', padding: '8px 0', width: '100%' }}
>
{resendLoading ? 'Đang gửi lại...' : 'Không nhận được mã? Gửi lại email'}
</button>
</form>
)}
</div>
