...
export function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: '/admin/inventory', label: 'Quản lý Robot', icon: '🗺️' },
    { path: '/admin/warehouses', label: 'Quản lý kho', icon: '🏭' },
    { path: '/admin/stocklevels', label: 'Tồn kho hiện tại', icon: '📦' },
    { path: '/admin/stockmovements', label: 'Lịch sử di chuyển', icon: '📋' },
    { path: '/admin/stockadjustments', label: 'Điều chỉnh tồn kho', icon: '🔧' },
    { path: '/admin/search', label: 'Tìm kiếm & AI', icon: '🔍' },
    { path: '/admin/notifications', label: 'Thông báo', icon: '🔔' },
    { path: '/admin/files', label: 'Quản lý File', icon: '📁' },
    { path: '/admin/promotions', label: 'Khuyến mãi', icon: '🏷️' },
    { path: '/admin/robots', label: 'Robot AMR', icon: '🤖' },
    { path: '/admin/wallet', label: 'Ví điện tử', icon: '💰' },
    { path: '/admin/profile', label: 'Hồ sơ', icon: '👤' },
