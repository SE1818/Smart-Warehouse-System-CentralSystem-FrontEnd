export interface Product { id: string; name: string; description?: string; category: string; price: number; stockQuantity: number; unit: string; imageUrl?: string; createdAt: string; updatedAt: string; }
