...
export interface Order { id: string; userId: string; items: OrderItem[]; totalAmount: number; status: string; shippingAddress: string; note?: string; createdAt: string; updatedAt: string; deliveryNodeId?: string; }
