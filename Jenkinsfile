                ...
                script {
                    dir('Smart-Warehouse-System-CentralSystem-FrontEnd') {
                        try {
                            ...
                            echo "SonarQube analysis bị bỏ qua hoặc lỗi: ${e.getMessage()}. Chuyển hướng chạy Build tiêu chuẩn."
                        }
                        sh 'npm run build'
                    }
                }
            ...
            steps {
                script {
                    ...
                    try {
                        ...
                        echo "Bỏ qua bước Push vì DOCKER_HUB_CREDS chưa cấu hình hoặc lỗi: ${e.getMessage()}"
                    }
                }
            }
        }
